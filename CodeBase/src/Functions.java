...
final class Functions
{
   ...
   {
	  //returns an entity's current image in animation
   ...
   {
	   //returns entity's animation period
      switch (entity.kind)
      {
      case MINER_FULL:
      case MINER_NOT_FULL:
   ...
   {
	   //increments imageIndex variable for entity's image list
   ...
   {
	   //executes animation given action
   ...
   public static void executeActivityAction(Action action,
      EventScheduler scheduler)
   {
	   //executes activity action depending on entity
   ...
   {
	   //schedules various actions in event scheduler depending on entity and action
      switch (entity.kind)
      {
      case MINER_FULL:
         scheduleEvent(scheduler, entity,
   ...
   {
	   //transforms an entity (miner?) from not full to full if resources were over allocated resources
   ...
   public static void transformFull(Entity entity, WorldModel world,
      EventScheduler scheduler, ImageStore imageStore)
   {
	   //transforms an entity (miner?) from full to not full 
   ...
   {
	   //returns / preps entity to move to adjacent target (if target is not adjacent, it moves entity to next position)
   ...
   public static boolean moveToOreBlob(Entity blob, WorldModel world,
      Entity target, EventScheduler scheduler)
   {
	   //returns / preps entity to move to adjacent oreBlob (if oreBlob is not adjacent, it moves entity to next position)
   ...
   public static Point nextPositionMiner(Entity entity, WorldModel world,
      Point destPos)
   {
	   //helper method for action method
   ...
   {
	   //returns whether points are adjacent
   ...
   {
	   //finds possible new points based off given point
   ...
   {
	   //schedules event for given entity
   ...
   public static void unscheduleAllEvents(EventScheduler scheduler,
      Entity entity)
   {
	   //unschedules events for given entity
